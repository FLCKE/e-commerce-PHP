...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#"><span>E-maillot</span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../user/Members.php"><i class="fas fa-user"></i> Members</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../product/product-dashboard.php"><i class="fas fa-box"></i> Products</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../promotion/admin_promotion.php"><i class="fas fa-gift"></i> Promotion</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../contact/Acontacts_page.php"><i class="fas fa-comments"></i> Service_Client</a>
                </li>
                <li class="nav-item">
